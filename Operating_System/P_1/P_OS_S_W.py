...
class WriterReaderSemaphore:
    def __init__(self, readers_count, writers_count):
        ...
        self.z = multiprocessing.Semaphore(1) # based on the booklet
        self.y = multiprocessing.Semaphore(1)
        self.rsem = multiprocessing.Semaphore(1)
    ...
    def reader(self, reader_id):
        ...
        self.z.acquire() # based on the booklet
        self.rsem.acquire()
        self.x.acquire()
        ...
        self.x.release()
        self.rsem.release()
        self.z.release() # based on the booklet
...
if __name__ == "__main__":
    ...
    Semaphore = WriterReaderSemaphore(readers, writers)
    Semaphore.run()